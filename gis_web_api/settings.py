"""
Django settings for gis_web_api project.
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'gis_web_api/templates')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
# STATIC_URL = '/static/'
# STATIC_ROOT = os.path.join(BASE_DIR, 'gis_app/static')

STATIC_URL = '/static/'
STATIC_ROOT = os.path.join(os.path.join(BASE_DIR, 'gis_app/static'))  # where static files are collected
